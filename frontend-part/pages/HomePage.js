...
let DashboardTemplate = () => html`
    <section class="hero-photo">
        ...
        <div class="hero-photo-content">
            <div class="hero-badge">Кинезитерапия • Рехабилитация • Стойка</div>
            <h1 class="hero-photo-title">
                Възстановяване на движение, сила и увереност
            </h1>
            <p class="hero-photo-subtitle">
                Професионална грижа за вашето тяло, съобразена с вашия начин на живот, болка и цели.
            </p>
    ...
    <section class="home-feature-grid">
        ...
        <article class="home-feature-card">
            ...
            <p>Със спокойна атмосфера, ясно обяснение и грижа за вашето комфортно и безопасно възстановяване.</p>
        </article>
        <article class="home-feature-card">
            <div class="home-feature-icon">03</div>
            <h3>Резултат, който се чувства</h3>
            <p>Фокус върху движение, сила, намаляване на болката и възвращане към по-активен начин на живот.</p>
        </article>
    </section>
    ...
    <section class="massage-article">
        <div class="massage-article-inner">
            ...
            <h2 class="massage-article-title">Защо физиотерапията е повече от просто отпускане</h2>

            <div class="massage-article-body">
                <p>
                    Кинезитерапията не е само моментна почивка за тялото — тя е реален терапевтичен инструмент.
                    Редовните сесии подобряват кръвообращението, намаляват мускулното напрежение и ускоряват
                    възстановяването след натоварване, травма или дълго седене.
                </p>
                <p>
                    Освен физическите ползи, работата върху стойката и движението помага на тялото да се върне в
                    естествен баланс. Чрез целенасочена работа върху проблемните зони, помагаме да намалите болката
                    и да възстановите уверената си мобилност.
                </p>
                <p>
                    Разбираме, че доверието се гради постепенно. Затова ви даваме възможност сами да проверите
                    текущото си състояние, преди да стъпите в кабинета ни.
                </p>
            </div>
